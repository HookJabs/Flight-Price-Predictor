...
def single_feature_input_fn(features, targets, batch_size = 1, shuffle = True, num_epochs = None):
...
def multi_feature_input_fn(features, targets, batch_size=1, shuffle=True, num_epochs=None):
